...
REM Usage:  run_one.bat tb_rect_write
...
"%QDIR%\vlog.exe" -sv -quiet %RTL%\spi_byte_master.sv %RTL%\reset_sync.sv %RTL%\debounce.sv %RTL%\framebuffer.v %RTL%\line_draw.sv %RTL%\dot_field.sv %RTL%\game_ctrl.sv %RTL%\lcd_ili9341_ctrl.sv %RTL%\lcd_test_top.sv %1.sv > _v_%1.txt 2>&1
