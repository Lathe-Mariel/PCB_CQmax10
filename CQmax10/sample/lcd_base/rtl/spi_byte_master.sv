...
module spi_byte_master #(
    parameter int HALF_PERIOD = 2      // system clock cycles per SCK half period
)(
    input  logic       clk,
    input  logic       rst,
    ...
    localparam int HPM1 = HALF_PERIOD - 1;
    localparam logic [DW-1:0] HALF_PERIOD_M1 = HPM1[DW-1:0];
    ...
    assign tick = (div_cnt == HALF_PERIOD_M1);
